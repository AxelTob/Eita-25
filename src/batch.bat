...
#skapa ett nyckelpar
keytool -genkeypair -keyalg RSA -keystore clientkeystore -alias keystore -dname "CN=Patient" -storepass password -keypass password
...
#skapa ett nyckelpar
keytool -genkeypair -keyalg RSA -keystore serverkeystore -alias serverkeystore -dname "CN=server" -storepass password -keypass password
